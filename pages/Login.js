...
<div className="flex items-center justify-center h-screen">
  ...
  <div className="min-w-fit flex-col border bg-white px-6 py-14 shadow-md rounded-[4px] ">
    <div className="mb-8 flex justify-center">
      <img className="w-24 " src="https://www.linkpicture.com/q/Auto-Lovers-Logo_1.jpg" alt="" />
    </div>
    <h1 className='mt-6 text-center text-2xl font-extrabold text-gray-900 mb-4' >Sign in to your account</h1>
