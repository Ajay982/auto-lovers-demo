...
const Checkout = ({cart, subTotal, addToCart, removeFromCart}) => {
  return (
    <div className="container px-2 sm:m-auto">
      ...
      <div  className=" h-full sideCart bg-purple-500 p-6 m-2 ">
      ...
      <div className="mx-8">
        <button className="flex mr-2  text-white bg-indigo-500 border-0 py-2 px-2 focus:outline-none hover:bg-indigo-600 rounded text-lg"><BsFillBagCheckFill className="m-1" /><Link href="/Order" legacyBehavior><a>Pay ₹ {subTotal} </a></Link> </button>
        </div>
